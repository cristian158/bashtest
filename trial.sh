...
# Logging function
log() {
    echo "[$(date +'%Y-%m-%d %H:%M:%S')] $1" | sudo tee -a /home/$USER/bashtest/script.log
}
...
# Setup dotfiles 
setup_dotfiles() {
    local dotfiles_dir="/home/$USER/.cfg"
    local dotfiles_backup="/home/$USER/.cfg-bk"
...
sudo cp /home/$USER/bashtest/pacman.conf /etc/pacman.conf
